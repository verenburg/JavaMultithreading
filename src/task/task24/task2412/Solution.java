        ...
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (compareName(stock1,stock2) != 0) {
                    compare = compareName(stock1,stock2);
                } else {
                    if (compareDate(stock1,stock2) != 0){
                        compare = compareDate(stock1,stock2);
                    } else {
                        compare = compareProfit(stock1,stock2);
                    }
                }
                return compare;
                //return (compare = compareName(stock1, stock2)) != 0 ? compare : (compare = compareDate(stock1,stock2)) != 0 ? compare : compareProfit(stock1,stock2);
            }
            ...
            private int getProfitPercentage(Stock stock) {
                ...
                if (stock.containsKey("change")) {
                    result = stock.containsKey("change") ? ((double) stock.get("change")) : 0 ;
